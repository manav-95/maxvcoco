                ...
                <div className='max-w-7xl container mx-auto px-4 poppins-regular'>
                    ...
                    <div className='hidden md:flex justify-between items-center'>
                        ...
                        <Slide triggerOnce direction='right'>
                            <NavLink to='/products/Premixes?start=0&end=4&title1=Cake Premixes&title2=Muffin Premixes' className='flex items-center bg-[#fbecdf] text-[#4e3620] font-medium text-lg px-6 py-2 rounded-full  transition-all duration-75 ease-in-out'>View More<FaArrowRight className="h-6 w-6 ml-2" /></NavLink>
                        </Slide>
                    </div>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 my-14'>
                        ...
                        <div>
                            <NavLink to='/products/Premixes?start=0&end=4&title1=Cake Premixes&title2=Muffin Premixes' className='flex items-center justify-center bg-[#fbecdf] text-[#4e3620] font-medium text-lg px-6 py-2 my-4 rounded-full transition-all duration-75 ease-in-out'>View More</NavLink>
                        </div>
                        </Slide>
